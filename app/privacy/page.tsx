    ...
    <div className="min-h-screen bg-[#f6f6f7] text-[#202223]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#2563eb]">1. Introduction</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#2563eb]">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#2563eb]">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#2563eb]">4. Data Sharing and Disclosure</h2>
            <p className="text-[#6d7175] leading-relaxed mb-4">
            ...
            <ul className="list-disc list-inside space-y-2 text-[#6d7175] ml-4">
              ...
              <li><strong>Pinterest:</strong> When you use the Pinterest Stock Sync automation, we use Pinterest’s API with your access token to create Pins (board, image, title, description, link) for out-of-stock products. See <a href="https://policy.pinterest.com/en/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-[#2563eb] hover:underline">Pinterest’s Privacy Policy</a> for how Pinterest handles data.</li>
            </ul>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#2563eb]">5. Data Security</h2>
            <p className="text-[#6d7175] leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#2563eb]">6. Your Rights (GDPR Compliance)</h2>
            <p className="text-[#6d7175] leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#2563eb]">7. Cookies and Tracking</h2>
            <p className="text-[#6d7175] leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#2563eb]">8. Data Retention</h2>
            <p className="text-[#6d7175] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#2563eb]">9. Children's Privacy</h2>
            <p className="text-[#6d7175] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#2563eb]">10. International Data Transfers</h2>
            <p className="text-[#6d7175] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#2563eb]">11. Changes to This Privacy Policy</h2>
            <p className="text-[#6d7175] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#2563eb]">12. Contact Us</h2>
            <p className="text-[#6d7175] leading-relaxed">
